...
def default_app_settings() -> AppSettingsResponse:
    ...
    return AppSettingsResponse(
        ...
        max_text_file_size_mb=settings.max_text_file_size_mb,
        max_pdf_file_size_mb=settings.max_pdf_file_size_mb,
        max_office_file_size_mb=settings.max_office_file_size_mb,
